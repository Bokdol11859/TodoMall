...
- **[Storybook]()**: Storybook은 디자인 시스템을 구축하기 위한 툴로, UI 테스팅이 간편해진다는 장점이 있습니다. 기존 CBT 개발 당시 UI 테스팅 툴을 사용하지 않아 디자인팀과의 소통에서 불편함을 겪었었기에 리팩토링 과정에서 Storybook을 도입하기로 결정했습니다. 또한, 다른 부서 팀원들이 UI 테스팅을 간편하게 할 수 있도록 Storybook을 배포를 하였고, Github Action을 통해 자동 배포를 구현했습니다. 
...
### 스토리북
<img width="1680" alt="Screen Shot 2023-02-19 at 10 57 17 PM" src="https://user-images.githubusercontent.com/80627536/219952885-3462b3c8-69ef-4818-92bb-7db3588c0fcb.png">
